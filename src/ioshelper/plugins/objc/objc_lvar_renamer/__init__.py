...
from .options import OBJC_LVAR_RENAMER_COMPONENT_NAME
...
# `[objc-lvar-renamer]` section of `ioshelper.cfg`. The hook resolves and logs those
# gates when it is instantiated, i.e. when this component loads.
