...
generic_calls_fix_component = OptimizersComponent.factory(
    "generic-calls-fixer", "Fix calls to generic kernel functions (safe_metacast, ...)", [generic_calls_fix_optimizer_t]
)
